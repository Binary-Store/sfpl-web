...
export default function DashboardLayout({ children }) {
  ...
  return (
    <div className="h-screen flex overflow-hidden">
      ...
      <div
        className={`
        fixed inset-y-0 left-0 z-50 bg-white border transform transition-all duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0
      ...
      >
        {/* Sidebar Header */}
        <div className="flex items-center justify-between border-b h-14 flex-shrink-0">
          {!isSidebarCollapsed && (
            <div
              className="mx-10 py-2 rounded-lg flex items-center justify-center cursor-pointer"
              onClick={() => router.push("/")}
            >
              <Image
                src="/logo.svg"
