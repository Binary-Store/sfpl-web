        ...
        <div className="flex items-center gap-4 bg-white text-black px-4 py-2 rounded-lg">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium">
              {alarmData ? new Date(alarmData.timestamp).toLocaleString("en-US", {day: "2-digit", month: "2-digit", year: "numeric", hour: "2-digit", minute: "2-digit"  , second: "2-digit" , hour12: true}) : "No data"}
            </span>
          </div>
        </div>
      </div>
