...
export default function CartPage() {
    ...
    const handleCheckout = async () => {
        ...
        try {
            // Create order first
            createOrderMutation({ order_id: Date.now().toString() }, {
                onSuccess: (response: any) => {
                    ...
                    const options = {
                        ...
                        handler: function (response: any) {
                            // Payment successful - verify order
                            verifyOrderMutation({
                                order_id: orderId,
                                                            ...
                                                            <input
                                                                ...
                                                                onBlur={(e) => {
                                                                    ...
                                                                    if (newQty >= 1 && newQty !== item.quantity) {
                                                                        handleDirectQuantityUpdate(item.id, newQty);
                                                                    }
                                                                }}
                                                                onKeyDown={(e) => {
                                                                    if (e.key === 'Enter') {
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 sticky top-24">
                            ...
                            <button 
                                ...
                                disabled={isCheckoutLoading || isCreatingOrder || cartItems?.length === 0}
