...
export default function CallAttenderPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (resumeFile) {
        ...
        data.append("position", "Call Attender");
    ...
    <section className="min-h-screen bg-gray-50 py-16">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <p className="text-gray-700 mb-8">
          Handle inbound and outbound calls, provide excellent customer support,
          and maintain call logs.
        </p>
